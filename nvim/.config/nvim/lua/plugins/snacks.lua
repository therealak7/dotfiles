...
╚══════╝╚══════╝╚═╝  ╚═╝   ╚═╝     ╚═══╝  ╚═╝╚═╝     ╚═╝
                ...
                sections = {
                    { section = "header" , cmd = "figlet -d $HOME/dotfiles/assets/fonts -f ANSIShadow \"zexy\" | lolcat --force-color"},
        ...
        keys = {
            ...
            -- TODO: Check if snacks picker is needed and use these functions in fzf-lua
            -- -- Snacks Picker
